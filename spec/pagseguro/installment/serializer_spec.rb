...
describe PagSeguro::Installment::Serializer do
  context "when there are installments" do
    ...
    it { expect(data[0]).to include(credit_card_brand: "visa") }
    ...
    it { expect(data[1]).to include(credit_card_brand: "visa") }
    ...
    it { expect(data[2]).to include(credit_card_brand: "visa") }
